...
# 🔥 News
- 2026.06: [Scientific Image Synthesis](https://arxiv.org/abs/2601.17027) is accepted by ECCV 2026! We benchmark scientific image synthesis and study its downstream utility.
- 2026.04: Two works are accepted by ACL 2026: [ChartVerse](https://arxiv.org/abs/2601.13606) and [SciFlow-Bench](https://arxiv.org/abs/2602.09809). Thanks to all collaborators!
- 2026.03: We released the data curation pipeline of [MMFineReason](https://mmfinereason.github.io/). Check out the [code](https://github.com/LHL3341/MMFineReason)!
- 2026.01: The [technical report](https://arxiv.org/abs/2601.21821) of [MMFineReason](https://mmfinereason.github.io/) is released. We close the multimodal reasoning gap via open data-centric methods. Our [datasets](https://huggingface.co/collections/OpenDataArena/mmfinereason) have received **20k+** downloads!
...
- `ECCV 2026` [Scientific Image Synthesis: Benchmarking, Methodologies, and Downstream Utility](https://arxiv.org/abs/2601.17027), **Honglin Lin**\*, Chonghan Qin*, Zheng Liu, Qizhi Pei, Yu Li, Zhanping Zhong, Xin Gao, Yanfeng Wang, Conghui He, Lijun Wu†
...
- `ACL 2026` [ChartVerse: Scaling Chart Reasoning via Reliable Programmatic Synthesis from Scratch](https://arxiv.org/abs/2601.13606), Zheng Liu\*, **Honglin Lin**\*, Chonghan Qin, Xiaoyang Wang, Xin Gao, Yu Li, Mengzhang Cai, Yun Zhu, Zhanping Zhong, Qizhi Pei, Zhuoshi Pan, Xiaoran Shang, Bin Cui, Conghui He, Wentao Zhang, Lijun Wu†
- `ACL 2026` [SciFlow-Bench: Evaluating Structure-Aware Scientific Diagram Generation via Inverse Parsing](https://arxiv.org/abs/2602.09809), Tong Zhang\*, **Honglin Lin**\*, Zhou Liu, Chong Chen, Wentao Zhang†
...
- 4th place in [DCVLR@NeurIPS2025](https://oumi.ai/blog/dcvlr-competition-results-data-curation), 2025
- Outstanding Undergraduate Awards of BUPT, 2025
- Undergraduate Student National Scholarship, 2022

# 💻 Internships
*2024.07 - Present*, [Shanghai AI Laboratory](https://www.shlab.org.cn/), Shanghai, China
